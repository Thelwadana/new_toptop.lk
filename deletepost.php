	<?php
		...
		if(isset($_POST['submit'])){
			...
			// Delete the specific row in the 'posts' table
			$sql = "DELETE FROM posts WHERE postid = $id";
			if (mysqli_query($conn, $sql)) {
				// Redirect to seller_dash.php after successful deletion
					...
					<div class="col-lg-12 post-list1">
						...
						<div class="card">
                            ...
                            <div class="card-body" style="color:blue;text-align:center;">
                              ...
                              <p class="card-text">"Are you sure you want to delete this information? This action cannot be undone."</p>
							  <form action="deletepost.php" method="post">

                                 
								 <button type="submit" name="submit" class="btn btn-danger btn-sm"style="margin-top:1rem;">Delete</button>
                              </form>
